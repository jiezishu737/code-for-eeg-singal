...
def save_model(args, model, name=''):
    ...
    torch.save(model, f'/home/mydata/eeg/per_trained_models/{name}.pt')


def load_model(args, name=''):
    name = save_load_name(args, name)
    model = torch.load(f'/home/mydata/eeg/per_trained_models/{name}.pt')
    return model


def getData(name="S1", time_len=1, dataset="DTU"):
    DTU_document_path = "/home/mydata/eeg/DTU/"
